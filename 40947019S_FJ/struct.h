...
cardSet cardType[29] = {
    ...
    {11, "Crane", "起重機", 2, 1, "建築師階段時，已打出此張卡牌的玩家可支付興建新建築物與原先擁有舊建築物的費用差額，將新建築物蓋在舊建築物的上方。\n    被覆蓋的卡牌不計分亦無效能，被覆蓋的生產建築其上方貨品則須棄置，\n    被覆蓋的禮拜堂其上方卡牌仍可保留計分"},
    ...
    {21, "Gold mine", "金礦坑", 1, 1, "淘金者階段時，已打出此張卡牌的玩家可在行動完成後，從卡牌堆上方翻開4張卡牌，若4張卡牌的費用皆不相同，可挑選其中1張加入手牌。\n    但只要任2張出現相同費用，則須全數棄置"},
